...
//     version 1.7.0
//     from Assets/_Develop/_Scripts/InputManager/MainControllerActions.inputactions
//
...
public partial class @MainControllerActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @MainControllerActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""MainControllerActions"",
    ""maps"": [
        {
            ""name"": ""LeftHand"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""move-keyboard"",
                    ""id"": ""08e33d98-b9c7-4450-a8d3-3ec06808cd31"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""d0bd0ae3-efaa-4251-b4bc-2444d7c847d1"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""bad8f7ee-ba24-44e4-9dc2-6cb91f48e946"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""724c3f48-c787-4c4f-92ef-2cbd669a2337"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""304df9f9-e968-4f67-a11f-2ae0c281e55f"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a89f3687-bd8b-4369-9edc-63dfcb35e961"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""turn-keyboard"",
                    ""id"": ""b4ae67c4-de3a-4d2a-a646-e81c84feea0a"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""1b62c739-ceb4-4574-a470-71eb8dd03415"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""30f39276-c493-460c-9431-55d1c78c9a9f"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""c6509314-a246-44ad-b8c8-5c0422570cd8"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""d1cd2830-0da8-4836-ab32-e29ce85019b7"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""hmdPresence"",
                    ""type"": ""Button"",
                    ""id"": ""0693d573-566a-409f-81d2-6053e0bf1682"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""fed26b60-494d-438a-965c-6f8170f24e30"",
    ...
    ""controlSchemes"": [
        ...
        m_HMD_hmdPresence = m_HMD.FindAction("hmdPresence", throwIfNotFound: true);
        // UI
    ...
    {
        private @MainControllerActions m_Wrapper;
        public LeftHandActions(@MainControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MainControllerActions m_Wrapper;
        public RightHandActions(@MainControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    private readonly InputAction m_HMD_hmdPresence;
    public struct HMDActions
    {
        private @MainControllerActions m_Wrapper;
        public HMDActions(@MainControllerActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @hmdPosition => m_Wrapper.m_HMD_hmdPosition;
        public InputAction @hmdRotation => m_Wrapper.m_HMD_hmdRotation;
        public InputAction @hmdPresence => m_Wrapper.m_HMD_hmdPresence;
        ...
        public void AddCallbacks(IHMDActions instance)
        {
            ...
            @hmdPresence.started += instance.OnHmdPresence;
            @hmdPresence.performed += instance.OnHmdPresence;
            @hmdPresence.canceled += instance.OnHmdPresence;
        }
    ...
    {
        private @MainControllerActions m_Wrapper;
        public UIActions(@MainControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MainControllerActions m_Wrapper;
        public EyeGazeActions(@MainControllerActions wrapper) { m_Wrapper = wrapper; }
    ...
    public interface IHMDActions
    {
        ...
        void OnHmdPresence(InputAction.CallbackContext context);
    }
